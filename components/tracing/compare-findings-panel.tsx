...
export function CompareFindingsPanel({
  ...
  if (collapsed) {
    return (
      <div className="flex h-full items-center justify-center bg-[#f3f3f3] border-l border-[#d9d9d9]">
        <button
          type="button"
          onClick={onToggleCollapse}
          className="flex flex-col items-center gap-1.5 py-3 px-1 hover:bg-[#e8e8e8] rounded-sm transition-colors cursor-pointer"
          title="Expand Deep Findings"
        >
          <ChevronLeft className="h-3 w-3 text-[#888]" />
          <span className="text-[11px] font-semibold uppercase tracking-wide text-[#666] [writing-mode:vertical-lr]">
            Findings
          </span>
        </button>
      </div>
        ...
        {onToggleCollapse && (
          <div className="border-b border-[#d9d9d9] bg-[#f3f3f3] px-3 py-2">
            ...
            >
              ...
              <span className="text-[11px] font-semibold uppercase tracking-wide text-[#666]">Deep Findings</span>
            </button>
          </div>
        )}
